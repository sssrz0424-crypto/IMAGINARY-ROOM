...
const BG_URL_FALLBACK = publicUrl("coral_door_scene/background/background.png");
const PHONE_FRAME_URL_FALLBACK = publicUrl(
  "coral_door_scene/phone_frame/phone_frame_mask.png"
);
const TWINS_URL_FALLBACK = publicUrl("coral_door_scene/双子.png");
